...
interface MapViewWithTransitionsProps {
  onViewStateChange?: (viewState: MapViewState) => void
  animatedViewState?: MapViewState
  transitionDuration?: number
}

/**
 * MapView with smooth camera transitions using FlyToInterpolator
 * Supports animated transitions for scrollytelling
 */
export default function MapViewWithTransitions({
  onViewStateChange,
  animatedViewState,
  transitionDuration = 2000
}: MapViewWithTransitionsProps) {
      ...
      <DeckGL
        ...
        onViewStateChange={(evt: any) => {
          if (evt.viewState && typeof evt.viewState === 'object') {
            const newViewState = evt.viewState as typeof viewState
